  ...
  [Lang.EN]: {
    ...
    tools: {
      ...
      map: {
        ...
        sharing: 'GENERATING...',
        shareHint: 'Generate a URL that reproduces your current marks and annotations.',
        shareCopied: 'Share link copied to clipboard.',
        shareFailed: 'Failed to copy share link. Please copy the URL manually.',
      ...
      tierlist: {
        ...
        openTool: 'BUILD TIERLIST',
        toolDesc: 'Rank characters into custom tiers. Export as image for sharing.',
  ...
  [Lang.ZH]: {
    ...
    tools: {
      ...
      map: {
        ...
        shareLink: '分享連結',
        sharing: '產生中...',
        shareHint: '產生一個連結，讓他人打開時看到同樣的標記與註釋。',
        shareCopied: '分享連結已複製到剪貼簿。',
        shareFailed: '分享連結複製失敗，請手動複製網址。',
        exportMap: '導出地圖',
        exporting: '處理中...',
        close: '中斷連線',
        toggleLabels: '顯示座標',
